...
const MyHistoryTrx = ({ myHistoryData, handlehistorybox }) => {
    ...
    // console.log("myHistoryData trx ", myHistoryData)
    return (
        <>
            {handlehistorybox === 2 ? (
                        ...
                        <div key={i} className="px-4 w-full mt-3">
                                        ...
                                        {item?.number == 0 ? (
                                            <>
                                                <div className="relative h-16 w-full">
                                                    <div
                                                        className="absolute inset-0 bg-customred"
                                                        style={{
                            ...
                            {activeIndex === i && (
                                <div className="w-full gap-2 mt-3 text-sm">
                                    ...
                                    <div className="bg-redLight text-whitew-full mt-1 py-2 flex items-center justify-between px-2  rounded-md">
                                        <p>Status</p>
