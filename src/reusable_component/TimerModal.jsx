  ...
  return (
    ...
    <div className={` rounded-2xl h-[20rem] xs:h-[22rem] xsm:h-[19.5rem] mt-14 xs:mt-[5.5rem] xsm:-mt-3 w-full absolute modal ${isOpen ? "block" : "hidden"}`}>
      ...
      <div className="modal-content relative flex items-center justify-center h-full mt-2">
        <div className={`flex items-center justify-center space-x-8 xsm:space-x-9 ${isWarning ? 'text-white' : 'text-green'}`}>
          <div className='bg-redLight  h-[10rem] w-[6.5rem] xsm:h-[12rem] xsm:w-[7.5rem] rounded-2xl flex items-center justify-center font-extrabold text-[10rem] '>
