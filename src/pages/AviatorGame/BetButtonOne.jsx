    ...
    <div className="w-full py-2  lg:py-0 lg:w-1/2 text-xsm xsm:text-sm px-2 lg:px-10 3xl:px-20 bg-blackAviator2 rounded-md flex flex-col items-center">
      ...
      <div className="grid grid-cols-5 gap-2 w-full ">
        <div className="col-span-2 flex flex-col items-center w-full ">
          ...
          {isAuto && (
            <div className="w-full text-xsm xsm:text-sm text-gray flex items-center justify-center">
              Auto Bet &nbsp;
              <button>
                {isAutoBetAndCashout.autoBet ? (
                  <BiToggleRight
        ...
        {betStatus ? (
          ...
          <div className="mt-2 col-span-3 w-full">
            <button
              ...
              className="w-full py-3 lg:px-8 border-greenBorderAviator border-[2px] bg-greenAviator text-white text-3xl rounded-3xl"
            >
              <p
                className="[text-shadow:_0_4px_8px_rgb(99_102_241_/_0.8)] 
                           text-white text-xl md:text-2xl leading-snug 
