...
function DiceHeader({ profileRefresher, gameResultHistory, setProfileRefresher }) {
    ...
    return (
        <div>
            <div className='h-10 w-full rounded-lg bg-[#444444]  flex items-center justify-between px-2'>
                <div className='flex items-start justify-start'>
                    <div className='h-7 w-24 bg-[#555555] rounded-xl flex items-center justify-between pr-4 border-black border-[0.5px] mr-1'>
                        <Link to={-1} >
                            <MdKeyboardArrowLeft className="font-extrabold text-4xl text-white" />
                        </Link>
                        <p className='text-white font-serif font-semibold text-[12px]'>Dice</p>
                    </div>
