...
import Lucky12Socket from "./Lucky16Socket";
import MenuModal from "./MenuModal";

function Lucky16Header({
  profileRefresher,
  gameResultHistory,
  setProfileRefresher,
}) {
  ...
  useEffect(() => {
    ...
    Lucky12Socket.on("demo_16card", handleSocket);
    return () => Lucky12Socket.off("demo_16card", handleSocket);
  }, []);
