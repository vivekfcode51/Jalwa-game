...
function KinoHeader({profileRefresher, gameResultHistory }) {
    ...
    // console.log("gameResultHistory",gameResultHistory)
    return (
        <div>
            <div className='h-10 w-full rounded-lg bg-[#005500]  flex items-center justify-between px-2'>
                <div className='flex items-start justify-start'>
                    <div className='h-7 w-24 bg-[#2b7009] rounded-xl flex items-center justify-between pr-4 border-black border-[0.5px] mr-1'>
                        <Link to={-1} >
                            <MdKeyboardArrowLeft className="font-extrabold text-4xl text-white" />
                        </Link>
                        <p className='text-white font-serif font-semibold text-[12px]'>KENO</p>
                    </div>
                ...
                <div className='flex items-start justify-start'>
                    ...
                    <div className='h-7 w-7 bg-gradient-to-l bg-[#2b7009] rounded-[100%] flex items-center justify-between pr-4 border-black border-[0.5px] ml-1'>

                        <div onClick={() => toggleMenuModal(true)}>
