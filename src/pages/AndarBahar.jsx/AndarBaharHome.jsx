  ...
  return (
    <>
      ...
      >
        ...
        {/* start bet image */}
        {startbetImage && (
          <div className="w-full z-50 absolute top-[28vh] flex items-center justify-center">
          ...
          >
            <div className="flex w-full justify-center items-center h-full relative">
              <input
                ...
                className="h-6 w-[80px] bottom-[3vh] bg-[#666666] absolute left-1 no-spinner placeholder:text-[10px] border-black border-[0.5px] text-center rounded-3xl text-white outline-none px-1"
              />
              {/* Profile Icon */}
