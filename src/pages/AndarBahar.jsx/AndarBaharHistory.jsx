          ...
          <div key={i} className="px-4 w-full mt-3">
            ...
            >
              <div className="col-span-2 flex items-center gap-2">
                ...
                <div>
                  <p>{item?.games_no}</p>
                  <p className="text-white opacity-65 text-[10px]">
                    {item?.created_at}
                  </p>
                </div>
              </div>
                ...
                <div>
                  <div
                    className={`font-bold flex items-center justify-center ${
                      item?.win_amount === 0 && item?.status === 0
            ...
            {activeIndex === i && (
              <div className="w-full gap-2 mt-3 text-sm">
                ...
                <div className="bg-redLight w-full mt-1 py-2 flex items-center justify-between px-2 text-white rounded-md">
                  ...
                  <p>
                    {item?.number == 1 ? (
                      <p className="text-bg3">In</p>
                    ) : item?.number == 2 ? (
                      <p className="text-red">Out</p>
                    ) : (
                      item?.number
                    )}
                  </p>
                  ...
                  {item?.status !== 0 ? (
                    <p>
                      {item?.win_amount == 0 ? (
                        ...
                        <span className="text-green">{item?.win_amount}</span>
                      )}
                    </p>
                  ) : (
                    <p>--</p>
